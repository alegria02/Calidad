...
<head>
	...
	$( document ).ready(function() {
		<%
			List<String> app = (List<String>)request.getAttribute("listaNombresApp");
			List<List<String>> informe =(List<List<String>>) request.getAttribute("mediciones");
		%>
	});
	</script>
</head>
								...
								<div class="box">
									...
									<div id="collapse4" class="body">
										<table id="dataTable"
											...
											<tbody>
												<% for (int j = 0; j < informe.size(); j++) {
														out.print("<tr>");
														out.print("<td>" + informe.get(j).get(0) + "</td>");
														out.print("<td>" + informe.get(j).get(1) + "</td>");
														out.print("<td>" + informe.get(j).get(2) + "</td>");
