 ...
 */
@WebServlet(name = "CargaLog4j", urlPatterns = { "/cargalog4j" }, initParams = { @WebInitParam(name = "log4jPropertiesFile", value = "/home/planillas/conf/log4j.properties") }, loadOnStartup = 1)
